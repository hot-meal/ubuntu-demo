...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["user", "downloads", "documents","torrents", "languages"],
            user: ["hot-meal@localhost"],
            downloads: ["who-moved-my-cheese.pdf", "the-bitcoin-standard.pdf", "7-habits-of-highly-effective-people.pdf", "javascript-the-good-parts.pdf"],
            documents: ["index.js", "react.js", "jquery.min.js", "main.css", "express.js", "sldb.db", "hello-world.mkv"],
            torrents: ["ubuntu-20.04.torrent", "kali-linux.torrent", "ethereum-node.torrent", "ipfs.torrent"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">hot-meal@localhost</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/hot-meal")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-hot-meal, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-hot-meal":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-hot-meal");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-hot-meal, todoist, trash, settings, sendmsg ]";
                }
                break;
            ...
            case "sudo":
                ...
                result = "<img class=' w-2/5' src='./images/memes/sudo.png' />";
                break;
            default:
                result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-hot-meal, todoist, trash, settings, sendmsg ]";
        }
